...
# Prerequisites: octopusos CLI installed and database initialized

set -e  # Exit on error

echo "=== Testing OctopusOS Project Import CLI ==="
echo ""
