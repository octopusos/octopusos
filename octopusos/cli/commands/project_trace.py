...
This module provides the `octopusos project trace` command to view:
- All repositories in a project
- Recent tasks by repository
- Cross-repository dependency statistics

Usage:
    octopusos project trace <project_id> [--format table|json|tree]
    octopusos project trace my-app
    octopusos project trace my-app --format json
    octopusos project trace my-app --limit 10
...
from octopusos.core.project.repository import ProjectRepository, RepoRegistry
