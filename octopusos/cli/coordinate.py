...
def coordinate(intent, policy, output, dry_run):
    ...
    Example:
        octopusos coordinate --intent intent_example_low_risk --policy semi_auto --output ./output
    """
    ...
    try:
        from octopusos.core.coordinator import CoordinatorEngine
...
def explain(intent):
    ...
    Example:
        octopusos coordinate explain --intent intent_example_low_risk
    """
