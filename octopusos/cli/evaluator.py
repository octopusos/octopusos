...
def run(input_set, output):
    ...
    try:
        from octopusos.core.evaluator import EvaluatorEngine
...
def diff(intent_a, intent_b):
    """Compare two intents"""
    try:
        from octopusos.core.evaluator import IntentNormalizer
...
def merge(strategy, inputs, output):
    ...
    try:
        from octopusos.core.evaluator import IntentNormalizer, MergePlanner
