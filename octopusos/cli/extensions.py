"""CLI tool for managing OctopusOS extensions

Usage:
    python -m octopusos.cli.extensions list
    python -m octopusos.cli.extensions install <zip_path>
    python -m octopusos.cli.extensions install-url <url> [--sha256 <hash>]
    python -m octopusos.cli.extensions uninstall <extension_id>
    python -m octopusos.cli.extensions enable <extension_id>
    python -m octopusos.cli.extensions disable <extension_id>
    python -m octopusos.cli.extensions show <extension_id>
"""
...
from octopusos.core.extensions import (
    ExtensionRegistry,
    ZipInstaller,
    ExtensionValidator,
)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Manage OctopusOS extensions",
