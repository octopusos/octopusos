...
def check_schema_version() -> tuple[bool, Optional[str]]:
    ...
    try:
        ...
        from octopusos.store.migrations import get_current_version, get_latest_version
        ...
        if current != latest:
            return False, (
                ...
                f"Please run: octopusos migrate"
            )

        return True, None
        
    except FileNotFoundError:
        return False, "Database not initialized. Please run: octopusos init"
