...
from octopusos.core.verify.schema_validator_service import SchemaValidatorService
...
def run(input, out, policy, db):
    ...
    Example:
        octopusos builder run --input examples/nl/nl_001.yaml --out outputs/builder/
    """
...
def explain(input, db):
    ...
    Example:
        octopusos builder explain --input examples/nl/nl_001.yaml
    """
    ...
    if registry:
        from octopusos.core.intent_builder.registry_query import RegistryQueryService
...
def validate(file):
    ...
    Example:
        octopusos builder validate --file outputs/builder/nl_001.output.json
    """
