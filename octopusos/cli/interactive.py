"""Interactive CLI: Main loop for OctopusOS CLI Control Plane"""
...
from octopusos.core.task import TaskManager, RunMode, ModelPolicy, TaskMetadata
from octopusos.config import load_settings, save_settings, CLISettings
from octopusos.i18n import set_language, t, get_available_languages
...
class InteractiveCLI:
    ...
    def start_task_runner(self, task_id: str, use_real_pipeline: bool = False):
        ...
        try:
            ...
            cmd = [sys.executable, "-m", "octopusos.core.runner.task_runner", task_id]
            if use_real_pipeline:
