...
Usage:
    ...
    python -m octopusos.cli.metrics show --last 24h
    python -m octopusos.cli.metrics show --start "2025-01-01" --end "2025-01-31"
"""
...
Examples:
  ...
  python -m octopusos.cli.metrics generate --start "2025-01-01" --end "2025-01-31" --output jan_report.json
