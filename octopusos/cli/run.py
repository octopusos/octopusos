...
from octopusos.core.mode import ModeSelector, ModePipelineRunner
...
def run_cmd(nl_input: str, repo: str, policy: str, output: str, dry_run: bool):
    """Run OctopusOS with natural language input
    ...
    Examples:
        ...
        octopusos run "I need a demo landing page"
        
        # Analyze code
        octopusos run "analyze the authentication flow"
        
        # Fix a bug
        octopusos run "fix the login bug"
    """
    console.print("\n[bold cyan]🚀 OctopusOS Mode Pipeline Runner[/bold cyan]\n")
