...
from octopusos.core.task import TaskManager, TraceBuilder
...
from octopusos.cli.commands.task_trace import task_trace as task_repo_trace
...
def resume_task(task_id: str, force: bool):
    ...
    try:
        ...
        console.print(f"  octopusos task show {task_id}")
        console.print(f"  octopusos task trace {task_id}")
