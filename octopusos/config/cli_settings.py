...
from octopusos.core.task.run_mode import RunMode, ModelPolicy
...
class SettingsManager:
    ...
    def __init__(self, settings_path: Optional[Path] = None):
        ...
        if settings_path:
            ...
            # Default: ~/.octopusos/settings.json
            home = Path.home()
            octopusos_dir = home / ".octopusos"
            octopusos_dir.mkdir(exist_ok=True)
            self.settings_path = octopusos_dir / "settings.json"
