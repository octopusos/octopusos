"""
Capability Authorizer - OctopusOS v3
...
from octopusos.core.agent.models import (
    AuthorizationResult,
    EscalationPolicy,
)
from octopusos.core.agent.agent_profile import AgentCapabilityProfile
...
class CapabilityAuthorizer:
    ...
    Usage:
        ...
        from octopusos.core.capability.domains.governance import get_governance_engine
    ...
    def authorize(
        ...
        from octopusos.core.capability.domains.governance.models import GovernanceContext
    ...
    def _handle_escalation(
        ...
        if policy == EscalationPolicy.DENY:
            ...
            from octopusos.core.agent.escalation_engine import EscalationEngine
    ...
    def _load_profile_from_db(
        ...
        try:
            ...
            from octopusos.core.agent.models import AgentTier, EscalationPolicy
    ...
    def _get_trust_tier_from_profile(self, profile: AgentCapabilityProfile):
        ...
        from octopusos.core.capability.domains.governance.models import TrustTier
    ...
    def _get_required_tier_for_risk(self, risk_level) -> int:
        ...
        from octopusos.core.capability.domains.governance.models import RiskLevel
