"""
Escalation Engine - OctopusOS v3
...
from octopusos.core.agent.models import EscalationRequest, EscalationStatus
...
class EscalationEngine:
    ...
    def approve_request(
        ...
        if governance_engine:
            from octopusos.core.agent.agent_tier import InsufficientPermissionError
