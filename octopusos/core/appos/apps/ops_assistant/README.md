...
```python
from octopusos.core.appos.apps.ops_assistant import StatusQueries

queries = StatusQueries("/path/to/octopusos.db")
...
```python
from octopusos.core.appos.apps.ops_assistant import SystemActions

actions = SystemActions("/path/to/octopusos.db")
