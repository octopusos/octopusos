...
术语识别策略（v0.1）：
1. 预定义术语表（可配置）
2. 大写模式识别（如 BrainOS, OctopusOS, TaskManager）
3. 文档中的粗体/代码块标记
...
- project: 项目特定（BrainOS, OctopusOS, Capability）
...
from octopusos.core.brain.models import Term, Edge, EdgeType, Evidence
...
class TermExtractor(BaseExtractor):
    ...
    Config:
        term_dict: 预定义术语字典（默认包含 OctopusOS 核心术语）
    ...
    # OctopusOS 预定义术语表（v0.1）
    DEFAULT_TERMS = {
        # 核心概念
        "OctopusOS", "BrainOS", "Task", "Executor", "Pipeline",
