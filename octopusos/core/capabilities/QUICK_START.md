...
The Capability Runner is part of the core OctopusOS system. No additional installation required.
...
- Tools must be in `.octopusos/tools/` or system PATH
...
context = ExecutionContext(
    # ... other params ...
    work_dir=Path(".octopusos/extensions/my.ext/work")
)
```
...
**Solution**: Ensure extension is installed and tool is in `.octopusos/tools/`

### Issue: "Work directory not safe"
**Solution**: Use a directory under `.octopusos/` or home directory
