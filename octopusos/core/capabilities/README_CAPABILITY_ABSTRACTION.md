...
```python
from octopusos.core.capabilities import CapabilityRegistry
...
```python
from octopusos.core.capabilities import ToolRouter, ToolInvocation
...
Same as OctopusOS project license.
