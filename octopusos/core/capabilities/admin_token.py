...
Usage:
    import os
    from octopusos.core.capabilities.admin_token import AdminTokenManager

    # Set admin token in environment
    os.environ["OCTOPUSOS_ADMIN_TOKEN"] = "my-secure-token"
...
class AdminTokenManager:
    ...
    - Uses OCTOPUSOS_ADMIN_TOKEN env var
    ...
    ENV_VAR_NAME = "OCTOPUSOS_ADMIN_TOKEN"
    ENV_VAR_SECRET = "OCTOPUSOS_ADMIN_TOKEN_SECRET"
    ...
    def _load_token(self):
        ...
        self._admin_token = os.environ.get(self.ENV_VAR_SECRET) or os.environ.get(self.ENV_VAR_NAME)
    ...
    def generate_token(self, user_id: str, expiry_minutes: int = 60) -> str:
        ...
        raise NotImplementedError(
            ...
            "Use environment variable OCTOPUSOS_ADMIN_TOKEN instead."
        )
...
def get_admin_token_manager() -> AdminTokenManager:
    ...
    current_token = os.environ.get(AdminTokenManager.ENV_VAR_SECRET) or os.environ.get(AdminTokenManager.ENV_VAR_NAME)
    if _token_manager is None:
        _token_manager = AdminTokenManager()
    elif _token_manager._admin_token != current_token:
        _token_manager = AdminTokenManager()
