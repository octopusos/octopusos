...
Example:
    ...
    from octopusos.core.capabilities.capability_models import ToolDescriptor
...
if TYPE_CHECKING:
    from octopusos.core.capabilities.governance_models.provenance import ProvenanceStamp
