...
class PolicyContextBuilder:
    ...
    def _get_tier(self, extension_id: str, action_id: str) -> str:
        ...
        try:
            ...
            from octopusos.core.capabilities.sandbox.risk_detector import get_extension_risk_level
    ...
    def _get_risk_score(self, extension_id: str, action_id: str) -> float:
        ...
        """
        try:
            from octopusos.core.capabilities.risk.scorer import RiskScorer
    ...
    def _check_authorization(
        ...
        """
        try:
            from octopusos.core.capabilities.governance import (
    ...
    def _check_sandbox_available(self) -> bool:
        ...
        """
        try:
            from octopusos.core.capabilities.sandbox import DockerSandbox
