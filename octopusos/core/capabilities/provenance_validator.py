...
from octopusos.core.capabilities.governance_models.provenance import ProvenanceStamp, ExecutionEnv
...
class ProvenanceValidator:
    ...
    def can_replay(
        ...
        if provenance.execution_env.octopusos_version != current_env.octopusos_version:
            logger.warning("Different OctopusOS version, replay may differ")
