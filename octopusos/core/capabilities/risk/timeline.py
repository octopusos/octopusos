...
Example:
    from octopusos.core.capabilities.risk.timeline import RiskTimeline
    from octopusos.core.capabilities.risk.scorer import RiskScorer

    # Initialize
    timeline = RiskTimeline(db_path="path/to/octopusos.db")
    scorer = RiskScorer(db_path="path/to/octopusos.db")
