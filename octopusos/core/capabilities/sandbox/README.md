...
The Sandbox Isolation module provides runtime isolation for HIGH risk extension execution in OctopusOS. It ensures untrusted extensions cannot access host resources without explicit authorization.
...
```python
from octopusos.core.capabilities.sandbox import DockerSandbox, HIGH_RISK_CONFIG
...
```python
from octopusos.core.capabilities.sandbox import HIGH_RISK_CONFIG
...
```python
from octopusos.core.capabilities.sandbox import MEDIUM_RISK_CONFIG
...
```python
from octopusos.core.capabilities.sandbox import LOW_RISK_CONFIG
...
```python
from octopusos.core.capabilities.sandbox.risk_detector import requires_sandbox
...
```python
from octopusos.core.capabilities.sandbox import SandboxConfig, DockerSandbox
...
```python
from octopusos.core.capabilities.runner_base.base import run_with_governance
...
```python
from octopusos.core.capabilities.sandbox import (
    DockerSandbox,
...
```bash
# Check imports
python3 -c "from octopusos.core.capabilities.sandbox import DockerSandbox; print('✅ OK')"
...
```python
from octopusos.core.capabilities.sandbox.interface import ISandbox
...
Part of OctopusOS - See main LICENSE file.
