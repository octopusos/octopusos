"""
OctopusOS v3 Capability System

This module provides the core capability infrastructure for OctopusOS v3:
...
Usage:
    from octopusos.core.capability import (
...
# Registry
from octopusos.core.capability.registry import (
    CapabilityRegistry,
    PermissionDenied,
    get_capability_registry,
)
...
# Path Validator
from octopusos.core.capability.path_validator import (
    PathValidator,
    PathValidationError,
    get_path_validator,
    GOLDEN_PATH_RULES,
...
from octopusos.core.capability.precondition_checker import (
    PreconditionChecker,
    PreconditionError,
    get_precondition_checker,
)
...
from octopusos.core.capability.side_effects_tracker import (
    SideEffectsTracker,
    SideEffectRecord,
    SideEffectSummary,
...
# Version info
__version__ = "3.0.0"
__author__ = "OctopusOS Team"
__description__ = "OctopusOS v3 Capability System - 27 atomic capabilities with Golden Path enforcement"
