...
from octopusos.core.capability.models import RiskLevel as CapabilityRiskLevel
...
class RiskCalculator:
    ...
    def _generate_recommendations(
        ...
        if risk_level == RiskLevel.MEDIUM and not any("approval" in r.lower() for r in recommendations):
            recommendations.append("Consider approval for medium-risk operations")
