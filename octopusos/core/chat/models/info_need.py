...
class ClassificationSignal(BaseModel):
    ...
    has_implicitly_time_sensitive: bool = Field(
        default=False,
        description="Question contains implicitly time-sensitive topics (weather, stock, etc.)"
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "has_implicitly_time_sensitive": self.has_implicitly_time_sensitive,
