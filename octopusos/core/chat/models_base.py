...
from octopusos.core.chat.models.external_info import ExternalInfoDeclaration

# Time formatting - Hard Contract (ADR-XXXX)
# Use lazy import to avoid circular dependencies
def parse_db_time(timestamp_str):
    """Lazy import to avoid circular dependency"""
    from octopusos.core.time import parse_db_time as _parse_db_time
    return _parse_db_time(timestamp_str)

def iso_z(dt):
    """Lazy import to avoid circular dependency"""
    from octopusos.core.time import iso_z as _iso_z
    return _iso_z(dt)
...
class ChatSession:
    ...
    def from_db_row(cls, row, lazy_migrate=True) -> "ChatSession":
        ...
        """
        from octopusos.store.timestamp_utils import from_epoch_ms, to_epoch_ms
    ...
    def to_db_dict(self) -> Dict[str, Any]:
        ...
        Part of Time & Timestamp Contract (ADR-XXXX).
        """
        from octopusos.store.timestamp_utils import to_epoch_ms
