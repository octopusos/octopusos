"""
Self-check module for OctopusOS Chat Engine.
...
CRITICAL_MODULES = [
    "octopusos.core.chat.communication_adapter",
    "octopusos.core.chat.auto_comm_policy",
    "octopusos.core.chat.info_need_classifier",
    "octopusos.core.chat.multi_intent_splitter",
    "octopusos.core.chat.context_builder",
    "octopusos.core.chat.adapters",
]
...
def run_startup_checks() -> bool:
    ...
    """
    logger.info("Running OctopusOS Chat Engine startup self-checks...")
