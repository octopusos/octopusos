...
### Command
```bash
pytest octopusos/core/chat/tests/test_comm_integration_gates.py -v --cov
```
...
-----------------------------------------------------------------------------------------
octopusos/core/chat/comm_commands.py             409    111    132     39  69.32%
octopusos/core/chat/communication_adapter.py      98     73     20      0  21.19%
octopusos/core/chat/guards/__init__.py             4      0      0      0 100.00%
octopusos/core/chat/guards/attribution.py         30      4     16      4  82.61%
octopusos/core/chat/guards/content_fence.py       19      3      2      0  76.19%
octopusos/core/chat/guards/phase_gate.py          20      1      4      1  91.67%
-----------------------------------------------------------------------------------------
...
**Primary Test File**:
```
octopusos/core/chat/tests/test_comm_integration_gates.py
```

**Related Files**:
```
octopusos/core/chat/comm_commands.py           (Command handlers)
octopusos/core/chat/communication_adapter.py   (Adapter layer)
octopusos/core/chat/guards/phase_gate.py       (Phase Gate Guard)
octopusos/core/chat/guards/attribution.py      (Attribution Guard)
octopusos/core/chat/guards/content_fence.py    (Content Fence Guard)
```
...
### Full Test Suite
```bash
pytest octopusos/core/chat/tests/test_comm_integration_gates.py -v
```

### With Coverage
```bash
pytest octopusos/core/chat/tests/test_comm_integration_gates.py -v \
  --cov=octopusos.core.chat.comm_commands \
  --cov=octopusos.core.chat.communication_adapter \
  --cov=octopusos.core.chat.guards \
...
pytest octopusos/core/chat/tests/test_comm_integration_gates.py::TestPhaseGate -v

# SSRF Protection tests only
pytest octopusos/core/chat/tests/test_comm_integration_gates.py::TestSSRFProtection -v

# Attribution tests only
pytest octopusos/core/chat/tests/test_comm_integration_gates.py::TestAttribution -v
```

### Single Test
```bash
pytest octopusos/core/chat/tests/test_comm_integration_gates.py::TestPhaseGate::test_comm_search_blocked_in_planning -v
```
