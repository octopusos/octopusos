...
pytest octopusos/core/chat/tests/test_comm_integration_gates.py::TestTrustTier -v
...
pytest octopusos/core/chat/tests/test_comm_integration_gates.py::TestContentFence -v

# Audit tests only
pytest octopusos/core/chat/tests/test_comm_integration_gates.py::TestAudit -v

# Integration tests only
pytest octopusos/core/chat/tests/test_comm_integration_gates.py::TestIntegration -v
```
...
```python
@patch('octopusos.core.chat.communication_adapter.CommunicationAdapter')
