...
from octopusos.core.chat.comm_commands import CommCommandHandler, BlockedError
from octopusos.core.chat.communication_adapter import CommunicationAdapter, SSRFBlockedError
from octopusos.core.chat.guards.phase_gate import PhaseGate, PhaseGateError
from octopusos.core.chat.guards.attribution import AttributionGuard, AttributionViolation
from octopusos.core.chat.guards.content_fence import ContentFence
...
class TestAudit:
    ...
    @patch('octopusos.core.chat.comm_commands.logger')
    @patch('octopusos.core.chat.communication_adapter.CommunicationAdapter')
