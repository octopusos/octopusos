...
CommunicationOS 是 OctopusOS 的外部通信模块，提供安全、可审计的外部网络交互能力。

## 目录结构

```
octopusos/core/communication/
...
```python
from octopusos.core.communication import (
    CommunicationService,
    ConnectorType,
)
from octopusos.core.communication.connectors import WebSearchConnector
...
```bash
pytest octopusos/core/communication/tests/
```
