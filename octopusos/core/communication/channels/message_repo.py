...
References:
    - octopusos/store/migrations/schema_v65_channel_messages.sql - Table schema
    - octopusos/store/migrations/v61_twilio_sessions.sql - Similar audit pattern
"""
...
class ChannelMessageRepo:
    ...
    Thread Safety:
        ...
        For concurrent writes, consider using octopusos.store.get_writer().
