...
References:
    - octopusos/communicationos/channels/sms/adapter.py - SMS adapter pattern
    - octopusos/store/migrations/schema_v65_channel_messages.sql - Database schema
...
from octopusos.core.communication.channels.message_repo import ChannelMessageRepo
...
class TwilioSMSChannel:
    ...
    def __init__(
        ...
        Args:
            ...
            db_path: Optional database path (defaults to OctopusOS database)
        ...
        if db_path is None:
            db_path = str(component_db_path("octopusos"))
