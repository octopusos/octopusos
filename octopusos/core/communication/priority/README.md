...
Edit `octopusos/core/communication/config/trusted_sources.yaml`:
...
```bash
python3 -m pytest octopusos/core/communication/tests/test_priority_scoring.py -v
```
...
Part of OctopusOS. See main project LICENSE.
