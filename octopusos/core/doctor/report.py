...
def print_report(checks: List[CheckResult], show_fix_commands: bool = True):
    ...
    console.print()
    console.print("[bold cyan]OctopusOS 环境检查[/bold cyan]")
    console.print()
...
def print_fix_commands(checks: List[CheckResult]):
    ...
    if has_fixes:
        ...
        console.print()
        console.print("  [bold cyan]octopusos doctor --fix[/bold cyan]")
        console.print()
...
def print_fix_summary(results: List[FixResult]):
    ...
    if fail_count == 0:
        ...
        console.print("  1. 重新运行检查: [cyan]octopusos doctor[/cyan]")
        console.print("  2. 运行测试: [cyan]uv run pytest -q[/cyan]")
        console.print("  3. 启动 OctopusOS: [cyan]uv run octopusos --help[/cyan]")
    else:
...
def print_dry_run_summary(checks: List[CheckResult]):
    ...
    console.print()
    console.print("  [bold]octopusos doctor --fix[/bold]")
    console.print()
