...
from octopusos.core.extensions.exceptions import InstallationError, ValidationError
...
DEFAULT_EXTENSIONS_DIR = Path.home() / ".octopusos" / "extensions"
...
class ZipInstaller:
    ...
    def install_from_upload(
        ...
        if install_dir.exists():
            logger.warning(f"Extension directory already exists: {manifest.id}")
            raise InstallationError(
    ...
    def install_from_url(
        ...
        with tempfile.TemporaryDirectory(prefix="octopusos_ext_") as temp_dir:
