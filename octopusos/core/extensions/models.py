...
class ExtensionInstallConfig(BaseModel):
    ...
    mode: str = Field(default="octopusos_managed", description="Installation mode")
...
def _default_python_config() -> "PythonConfig":
    """Default Python config based on current interpreter version."""
    return PythonConfig(version=f"{sys.version_info.major}.{sys.version_info.minor}")
...
class ExtensionManifest(BaseModel):
    ...
    python: PythonConfig = Field(
        default_factory=_default_python_config,
