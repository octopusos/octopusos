...
from octopusos.core.extensions.exceptions import ValidationError
from octopusos.core.extensions.models import ExtensionManifest
from octopusos.core.extensions.policy import PolicyChecker
...
class ExtensionValidator:
    ...
    def validate_manifest(manifest_dict: Dict[str, Any]) -> ExtensionManifest:
        ...
        try:
            from octopusos.core.capabilities.schema import validate_manifest_with_schema
