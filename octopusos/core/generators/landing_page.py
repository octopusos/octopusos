...
from .landing_page_plan import LandingPagePlan, create_default_octopusos_plan
...
class LandingPageGenerator:
    ...
    def __init__(self):
        # 模板在 octopusos/templates/landing_page/
        # 当前文件在 octopusos/core/generators/landing_page.py
        # 需要向上两级再进入 templates
        current_file = Path(__file__)  # octopusos/core/generators/landing_page.py
        octopusos_dir = current_file.parent.parent.parent  # octopusos/
        self.template_dir = octopusos_dir / "templates" / "landing_page"
    ...
    def generate_planning_output(self, nl_input: str) -> str:
        ...
        """
        # 创建 JSON Plan
        plan = create_default_octopusos_plan()
...
<head>
    ...
    <title>OctopusOS - AI Execution Operating System</title>
