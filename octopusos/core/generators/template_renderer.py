    ...
    <section id="architecture">
        <div class="container">
            ...
            <p class="architecture-description">
                OctopusOS provides an OS-level governance layer that sits between AI agents and your systems,
        ...
        <div class="container">
            <div class="footer-content">
                ...
                <div class="footer-section">
                    <h4>Links</h4>
                    <ul>
                        <li><a href="https://github.com/yourusername/octopusos">GitHub</a></li>
                        <li><a href="https://github.com/yourusername/octopusos/docs">Documentation</a></li>
                        <li><a href="https://github.com/yourusername/octopusos/issues">Issues</a></li>
                    </ul>
                </div>
                <div class="footer-section">
                    <h4>Community</h4>
            ...
            <div class="footer-bottom">
                <p>&copy; 2026 OctopusOS Team. Licensed under MIT.</p>
            </div>
        </div>
    </footer>"""
