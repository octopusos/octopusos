...
1. **核心模块**:
   - `octopusos/core/lead/contract/__init__.py` (15 行)
   - `octopusos/core/lead/contract/mapper.py` (277 行)
...
3. **文档**:
   - `octopusos/core/lead/contract/README.md` (本使用文档)
   - `octopusos/core/lead/contract/DELIVERY.md` (本交付文档)

### 修改文件

1. **octopusos/jobs/lead_scan.py**:
