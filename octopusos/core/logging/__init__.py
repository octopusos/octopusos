"""
System logging components for OctopusOS.
...
from octopusos.core.logging.context import (
    set_log_context,
    get_current_task_id,
...
def __getattr__(name):
    ...
    if name == "LogStore":
        from octopusos.core.logging.store import LogStore
        return LogStore
    elif name == "LogCaptureHandler":
        from octopusos.core.logging.handler import LogCaptureHandler
