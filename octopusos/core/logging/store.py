...
from octopusos.core.logging.models import LogEntry
...
class LogStore:
    ...
    def _init_persistence(self) -> None:
        ...
        See: octopusos/store/migrations/schema_v06.sql (initial schema)
              octopusos/store/migrations/schema_v24.sql (updates)
        ...
        try:
            ...
            if not cursor.fetchone():
                ...
                raise RuntimeError(
                    ...
                    "Please run migrations first: python -m octopusos.store.migrations.run_p0_migration"
                )
            conn.close()
