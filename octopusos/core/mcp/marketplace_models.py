...
by the OctopusOS policy engine.
...
class MCPPackage(BaseModel):
    ...
    Connection Status:
    - is_connected: Whether this package is currently connected to local OctopusOS
    ...
    is_connected: bool = Field(
        False,
        description="Whether this MCP is connected to local OctopusOS"
    )
