...
from octopusos.core.project_kb.config import VectorRerankConfig
...
def create_provider(config: VectorRerankConfig) -> IEmbeddingProvider:
    ...
    if config.provider == "local":
        try:
            from octopusos.core.project_kb.embedding.local_provider import (
            ...
            raise ImportError(
                ...
                f"Install with: pip install octopusos[vector]\n"
                f"Original error: {e}"
            )
