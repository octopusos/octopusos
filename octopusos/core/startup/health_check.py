...
Example:
    from octopusos.core.startup import run_startup_health_check, HealthCheckMode
...
class StartupHealthCheck:
    ...
    def run_all_checks(self) -> Tuple[bool, Dict]:
        ...
        Example:
            ...
            checker = StartupHealthCheck(str(component_db_path("octopusos")))
    ...
    def check_sqlite_wal(self) -> Tuple[bool, str]:
        ...
        WAL mode enables better concurrency for OctopusOS multi-worker scenarios.
        """
        if not self.db_path.exists():
...
def run_startup_health_check(
    ...
    Examples:
        ...
        result = run_startup_health_check(
            str(component_db_path("octopusos")),
            mode=HealthCheckMode.STRICT
        )
