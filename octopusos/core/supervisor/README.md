...
Supervisor 是 OctopusOS 治理体系的核心组件，负责监听任务状态变化、评估风险、做出决策并触发相应的 Gate 动作。
...
from octopusos.core.supervisor import SupervisorService
from octopusos.core.supervisor.supervisor import SupervisorProcessor
from octopusos.core.supervisor.router import PolicyRouter
from octopusos.core.supervisor.policies import (
    OnTaskCreatedPolicy,
...
# 配置
db_path = Path("~/.octopusos/store/registry.sqlite").expanduser()
...
```python
from octopusos.core.supervisor.adapters import AuditAdapter
...
```python
from octopusos.core.supervisor.inbox import InboxManager
...
```python
from octopusos.core.supervisor.policies.base import BasePolicy
from octopusos.core.supervisor.models import Decision, DecisionType
