...
Usage:
    from octopusos.core.task.replay_task_lifecycle import TaskLifecycleReplayer
    from octopusos.core.storage.paths import component_db_path

    replayer = TaskLifecycleReplayer(str(component_db_path('octopusos')))
...
if __name__ == "__main__":
    ...
    parser.add_argument('--db', default=None, help='Database path (default: component_db_path("octopusos"))')
    ...
    if args.db is None:
        args.db = str(component_db_path("octopusos"))
