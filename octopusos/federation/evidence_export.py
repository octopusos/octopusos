...
from octopusos.federation.evidence_schema import (
    TrustEvidence,
...
class TrustEvidenceExporter:
    ...
    def _generate_system_id(self) -> str:
        ...
        return f"octopusos-{hostname}-{timestamp}"

    def _detect_policy_engine(self) -> PolicyEngine:
        """Detect Policy Engine capabilities."""
        try:
            # Try to import policy engine
            from octopusos.core.policy.execution_policy import ExecutionPolicy
    ...
    def _detect_sandbox(self) -> SandboxCapability:
        ...
        try:
            ...
            from octopusos.core.capabilities.sandbox.docker_sandbox import DockerSandbox
    ...
    def _detect_risk_scoring(self) -> RiskScoring:
        ...
        try:
            ...
            from octopusos.core.capability.domains.governance.risk_calculator import RiskCalculator
    ...
    def _detect_trust_evolution(self) -> TrustEvolution:
        ...
        try:
            ...
            from octopusos.core.governance.states import TrustState
