...
graph TB
    ...
    Settings -->|保存/Save| ConfigFile[~/.octopusos/settings.json]
...
sequenceDiagram
    ...
    LocaleManager-->>Interactive: "OctopusOS CLI - Task Control Plane"
    ...
    Settings->>Settings: Write to ~/.octopusos/settings.json
