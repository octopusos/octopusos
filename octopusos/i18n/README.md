# OctopusOS 国际化 (i18n) 功能

## 快速开始

### 用户使用

启动 OctopusOS CLI 并切换语言：
...
```python
from octopusos.i18n import t, set_language, get_available_languages
...
翻译文件位于 `octopusos/i18n/locales/`:

```
octopusos/i18n/locales/
├── en.json      # 英语翻译
└── zh_CN.json   # 简体中文翻译
```
...
语言设置保存在 `~/.octopusos/settings.json`:
