...
from octopusos.providers.process_manager import (
...
from octopusos.providers.logging_utils import get_provider_logger, OperationTimer
...
class OllamaController:
    ...
    def _emit_status_event(self, state: str, pid: Optional[int]):
        ...
        """
        try:
            from octopusos.core.events import Event, get_event_bus
