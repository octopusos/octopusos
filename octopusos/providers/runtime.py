...
- Runtime state persistence (~/.octopusos/runtime/providers.json)
...
from octopusos.core.utils.process import terminate_process, kill_process, is_process_running
...
class RuntimeStateManager:
    ...
    Stores PID and metadata in ~/.octopusos/runtime/providers.json
    """

    def __init__(self, state_file: Optional[Path] = None):
        if state_file is None:
            # Default to ~/.octopusos/runtime/providers.json
            home = Path.home()
            runtime_dir = home / ".octopusos" / "runtime"
