...
The Task Router is a core component of OctopusOS that intelligently selects provider instances for task execution based on capability requirements, with full explainability and auditability.
...
```python
from octopusos.router import Router
...
```python
from octopusos.router import RouterPersistence
...
```python
from octopusos.router import router_events
...
python -m octopusos.router.example
```
...
- Specification: `/Users/pangge/PycharmProjects/OctopusOS/docs/todos/reouter.md`
- Provider Architecture: `/Users/pangge/PycharmProjects/OctopusOS/octopusos/providers/`
- Event System: `/Users/pangge/PycharmProjects/OctopusOS/octopusos/core/events/`
- Database Schema: `/Users/pangge/PycharmProjects/OctopusOS/octopusos/store/`
