...
4. Cache management: Store in ~/.octopusos/store/skills_cache/<skill_id>/<repo_hash>/
"""
...
from octopusos.skills.manifest import (
    load_manifest,
    validate_manifest,
    normalize_manifest,
)
    ...
    def __init__(self, registry: SkillRegistry, cache_dir: Optional[Path] = None):
        ...
        Args:
            ...
            cache_dir: Cache directory for downloaded repositories
                      (default: ~/.octopusos/store/skills_cache/)
        """
        self.registry = registry
        self.cache_dir = cache_dir or (Path.home() / ".octopusos" / "store" / "skills_cache")
