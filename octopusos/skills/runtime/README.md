...
Runtime execution engine for OctopusOS skills with phase gate and permission guards.
...
registry = SkillRegistry()  # Uses ~/.octopusos/store/skill/db.sqlite
...
```python
from octopusos.skills.runtime import (
    PhaseViolationError,
