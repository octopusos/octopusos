...
-- Description: Core infrastructure for OctopusOS Extension system
-- Purpose: Enable installable capability packages management
-- Migration from v0.32 -> v0.33
--
-- Background:
--   - OctopusOS needs a plugin/extension system for third-party integrations
--   - Extensions are zip packages with manifest, commands, and install plans
--   - Extensions cannot import/patch OctopusOS core (security boundary)
...
--    - Installer extracts to ~/.octopusos/extensions/<extension_id>/
...
--   - No direct import of OctopusOS code
