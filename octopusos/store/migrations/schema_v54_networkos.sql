...
-- OctopusOS NetworkOS Component: 统一网络隧道管理
--
-- Design Philosophy:
...
VALUES (
    ...
    'octopusos-webui.trycloudflare.com',
    'localhost:8080',
    'http',
    'unknown',
    strftime('%s', 'now') * 1000,
...
VALUES (
    ...
    'octopusos-api',
    0,  -- Disabled by default
    'octopusos-api.trycloudflare.com',
    'localhost:8000',
    'http',
    'unknown',
    strftime('%s', 'now') * 1000,
...
-- ===================================================================
-- Design Rationale:
-- - Single component database (follows OctopusOS storage pattern)
