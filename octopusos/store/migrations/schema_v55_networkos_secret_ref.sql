...
VALUES (
    ...
    'CRITICAL: Eliminates plaintext token storage in database. Prevents token leakage in diagnostic exports and database dumps. Tokens now stored in encrypted secure storage (~/.octopusos/secrets.json with 0600 permissions).'
);
...
-- - Stored in: ~/.octopusos/secrets.json
--
-- ===================================================================
