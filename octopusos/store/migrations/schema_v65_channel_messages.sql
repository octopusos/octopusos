...
--
-- References:
-- - octopusos/communicationos/channels/sms/adapter.py - SMS channel implementation
-- - octopusos/communicationos/channels/whatsapp_twilio.py - WhatsApp channel
-- - octopusos/store/migrations/v61_twilio_sessions.sql - Voice session audit trail
--
-- Architecture:
