...
--
-- Purpose:
-- - Store federated trust relationships between OctopusOS systems
...
-- =============================================================================
-- Stores active federated trust relationships with remote OctopusOS systems.
...
CREATE TABLE IF NOT EXISTS federated_trust (
    ...
    remote_system_id TEXT NOT NULL,            -- Remote system identifier (e.g., "official-octopusos")
...
--
-- 1. LOCAL SOVEREIGNTY:
--    - Each OctopusOS controls its own trust
