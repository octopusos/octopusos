...
from octopusos.communicationos.providers.email.smtp_imap import SmtpImapProvider
...
```python
from octopusos.communicationos.channels.email import CursorStore

# Default location (in OctopusOS data directory)
...
```python
from octopusos.communicationos.providers.email.gmail import GmailProvider
...
```python
from octopusos.communicationos.providers.email.outlook import OutlookProvider
...
from octopusos.communicationos.channels.email import EmailAdapter
from octopusos.communicationos.providers.email.gmail import GmailProvider
