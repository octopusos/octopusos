# Email Channel for OctopusOS CommunicationOS
...
1. Navigate to OctopusOS Communication Channels
...
1. **New Thread Test**
   ...
   - Verify message appears in OctopusOS
   - Check conversation_key is created

2. **Reply Test**
   - Reply from OctopusOS
...
**Problem: Messages not appearing in OctopusOS**
