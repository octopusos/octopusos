...
class SlackAdapter:
    ...
    def verify_signature(
        ...
        """
        from octopusos.communicationos.channels.slack.client import verify_signature as verify_slack_signature
    ...
    def send_message(self, message: OutboundMessage) -> bool:
        ...
        """
        from octopusos.communicationos.channels.slack.client import post_message
