...
from octopusos.communicationos.models import OutboundMessage, InboundMessage, MessageType
...
from octopusos.core.time import utc_now_ms, utc_now
...
class SmsAdapter:
    ...
    def _audit_log_send(
        ...
        # Log to audit store
        from octopusos.communicationos.message_bus import ProcessingStatus
    ...
    def send_test_message(self, test_to_number: str) -> tuple[bool, Optional[str]]:
        ...
        test_message = OutboundMessage(
            ...
            type=MessageType.TEXT,
            text="OctopusOS SMS Test: Connection successful! Your SMS channel is working.",
            metadata={"test": True}
        )
