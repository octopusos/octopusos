...
The Telegram adapter enables OctopusOS to receive and send messages via Telegram Bot API. It provides:
...
### Inbound Messages (Telegram → OctopusOS)
...
```python
from octopusos.communicationos.channels.telegram import TelegramAdapter
from octopusos.communicationos.channels.telegram.client import set_webhook
