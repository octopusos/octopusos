...
```python
from octopusos.communicationos.providers.email import generate_auth_url
...
```python
from octopusos.communicationos.providers.email import exchange_code_for_tokens
...
```python
from octopusos.communicationos.providers.email import GmailProvider
...
```python
from octopusos.communicationos.providers.email.gmail_client import GmailAPIError
...
token_file = os.path.expanduser("~/.octopusos/gmail_tokens.json")
...
- **Protocol Interface:** `octopusos/communicationos/providers/email/__init__.py`
