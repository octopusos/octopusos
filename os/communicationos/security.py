...
from octopusos.communicationos.manifest import SecurityMode
...
class SecurityPolicy:
    ...
    def is_command_allowed(self, command: str) -> bool:
        ...
        # Alias mapping: keep strict whitelist semantics while supporting
        # common UX shortcuts used in IM channels.
...
class RemoteExposureDetector:
    ...
    def is_remote_exposed() -> bool:
        ...
        remote_indicators = [
            os.getenv("OCTOPUSOS_REMOTE_MODE", "").lower() == "true",
