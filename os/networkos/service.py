...
from octopusos.networkos.store import NetworkOSStore, Tunnel
from octopusos.networkos.providers.cloudflare import CloudflareTunnelManager
    ...
    def _get_token(self, tunnel_id: str) -> str:
        ...
        if secret_ref:
            ...
            raise NotImplementedError(
                ...
                f"Please run: octopusos networkos migrate-secrets {tunnel_id}"
            )
        ...
        if token:
            logger.warning(
                ...
                f"Run migration: octopusos networkos migrate-secrets {tunnel_id}"
            )
            return token
        ...
        if secure_storage_save_fn is None:
            try:
                ...
                raise NotImplementedError(
                    ...
                    "Please ensure octopusos.webui.secrets module is available."
                ) from e
