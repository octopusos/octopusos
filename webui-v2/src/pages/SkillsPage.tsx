...
export default function SkillsPage() {
  ...
  const loadSkills = useCallback(async () => {
    ...
    try {
      ...
      const skillsData = Array.isArray(response?.skills) ? response.skills : []
      const transformedSkills: SkillRow[] = skillsData.map((skill: any) => ({
        ...skill,
        id: typeof skill.skill_id === 'string' ? skill.skill_id : String(skill.id ?? ''),
